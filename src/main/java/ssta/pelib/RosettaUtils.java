...
public class RosettaUtils {
   ...
   */
  {
    java.util.ArrayList<T> L = new ArrayList<>(g.size());
    java.util.Queue<T> S = new java.util.concurrent.LinkedBlockingDeque<>();
    java.util.HashSet<T> V = new java.util.HashSet<>(),
   ...
   *
   * @param data List of mutable input elements.
